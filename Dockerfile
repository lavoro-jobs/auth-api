...
COPY ./lavoro-auth-api/requirements.txt /app/requirements.txt
...
COPY ./lavoro-auth-api/lavoro_auth_api /app/lavoro_auth_api
...
COPY ./lavoro_auth_api /app/lavoro_auth_api

ENV PYTHONPATH "${PYTHONPATH}:/app"

RUN pip install gunicorn

CMD ["gunicorn", "lavoro_auth_api.auth_api:app", "-w", "4", "-k", "uvicorn.workers.UvicornWorker", "-b", "0.0.0.0:80"]
